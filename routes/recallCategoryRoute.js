...
router.post("/add", Authenticate, Authorize("admin"), upload, categoryValidator, categoryValidationHandler, addRecallCategory); 
router.delete("/delete/:id", Authenticate, Authorize("admin"), deleteRecallCategory); 
router.put("/update/:id", Authenticate, Authorize("admin"), upload, updateRecallCategory); 
